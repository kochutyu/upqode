  ...
  _createClass(Slider, [{
    ...
    value: function getRadioIndex() {
      ...
      if (getClassName === section) {
        ...
        var _iterator2 = _createForOfIteratorHelper(sliderRadio),
            _step2;
    ...
    key: "workWithHeader",
    value: function workWithHeader(section, nextSlide) {
      var radioIndex = this.getRadioIndex(section, nextSlide);
...
function getMapData(state) {
  ...
  for (var i = 0; i < listMap.length; i++) {
    ...
    if (i !== state) {
      ...
      document.querySelectorAll('.map-icon')[i].children[0].classList.remove('location__icon_svg'); // document.querySelectorAll('.location__icon')[state].children[0].classList.add('location__icon_svg')
    }
